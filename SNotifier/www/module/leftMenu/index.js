      ...
      $scope.showPopup = function (data) {
        ...
        if (parseInt(text) > 5) {
          ...
          var alertPopup = $ionicPopup.alert({
            title: '<b class="text-center"> Thank You </b>',
            template: '<style> .popup{ background: white!important;background-color: black;border: 3px solid #e3e3e3;border-radius: 4px;box-shadow: 10px 10px 5px #888888; }  .popup-container { opacity: 1;} </style> <p class="text-center">Your position in queue : <span style="font-size: large;"> ' + data + ' </span> </p> <br /> <p class="text-center"> Next notification at position <span style="font-size: large;"> 5 </span> </p>  '
          });
          ...
          var alertPopup = $ionicPopup.alert({
            title: '<b class="text-center"> Thank You </b>',
            template: '<style> .popup{ background: white!important;background-color: black;border: 3px solid #e3e3e3;border-radius: 4px;box-shadow: 10px 10px 5px #888888; }  .popup-container { opacity: 1;} </style> <p class="text-center">Your position in queue : <span style="font-size: large;"> ' + data + ' </span> </p>'
          });
          alertPopup.then(function (res) {
            console.log('Done ');
          });
